  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-200">
        <h3 className="text-lg font-bold text-gray-900">Fuel / Transmission Options</h3>
        <p className="text-sm text-gray-500 mt-0.5">Select a fuel/transmission version to see the price</p>
      </div>
        ...
        <table className="w-full min-w-[600px] text-left">
          ...
          <tbody>
            {versions.map((v) => {
              ...
              } cursor-pointer ${inStock ? "" : "opacity-75"}`
